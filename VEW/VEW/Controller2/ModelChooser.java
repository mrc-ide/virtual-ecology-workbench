...
public class ModelChooser extends JPanel {
  ...
  public void updateButtons() {
    renameModel.setEnabled(modelChoice.getSelectedIndices().length==1);
    deleteModel.setEnabled(modelChoice.getSelectedIndices().length==1);
    loadModel.setEnabled(modelChoice.getSelectedIndices().length==1);    
  }
